.. _edX LMS API Endpoints:

################################################
edX LMS API Endpoints
################################################

The edX LMS API allows you to view information about users and their course enrollments, course information, and videos and transcripts.
